...
*******************************************
	...
	* v2 - Intensive Tobit (Sidak)	
	qui wyoung $no_tobit, cmd(tobit OUTCOMEVAR conflict_time1 CONFLICT1 TIME i.ANNO i.MUNICIPIO $controls [pw=F_EXP], vce(cluster MUNICIPIO) ll(0) ul(24)) familyp(conflict_time1) cluster(MUNICIPIO) bootstraps(100) seed(12345)
	...
	* v2 - Intensive Tobit (Sidak) - Year interaction
	qui wyoung $no_tobit, cmd(tobit OUTCOMEVAR conflict_time12016 conflict_time12020 CONFLICT1 TIME2016 TIME2020 i.ANNO i.MUNICIPIO $controls [pw=F_EXP], vce(cluster MUNICIPIO) ll(0) ul(24)) familyp(conflict_time12016 conflict_time12020) cluster(MUNICIPIO) bootstraps(100) seed(12345)
	...
	* v3 - Extensive Dummys (Rwolf)
	...
	indepvars(conflict_time1, conflict_time1, conflict_time1, conflict_time1) reps(1000) seed(12345)
	...
	* v3 - Extensive Dummys (Rwolf) - Year interaction
	...
	indepvars(conflict_time12016 conflict_time12020, conflict_time12016 conflict_time12020, conflict_time12016 conflict_time12020, conflict_time12016 conflict_time12020) reps(1000) seed(12345)
