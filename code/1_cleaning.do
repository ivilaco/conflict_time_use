...
*******************************************
	...
	* D. Me quedo con las variables de interés
	...
	keep COD_MPIO COD_DEPTO DIRECTORIO SECUENCIA_P ORDEN P7310 P1152 P6090 P6020 P6040 P6210 P425 P1176S1 P1176S2 P1176S3 P1176S4 P1176S5 P1176S6 P1176S7 P1176S9 P1176S10 P1176S11 P1176S12 REGION $time1 P1169S*
	gen ANNO = "2012-2013"
...
foreach file of local data {
	...
	* D. Me quedo con las variables de interés
	...
	keep COD_MPIO COD_DEPTO DIRECTORIO SECUENCIA_P ORDEN P7310 P1152 P6090 P6020 P6040 P6210 P425 P1176S1 P1176S2 P1176S3 P1176S4 P1176S5 P1176S6 P1176S7 P1176S9 P1176S10 P1176S11 P1176S12 REGION $time2 P1169S* // 272 variables
	gen ANNO = "2016-2017"
...
*******************************************
	...
	* D. Me quedo con las variables de interés
	keep COD_MPIO COD_DEPTO DIRECTORIO SECUENCIA_P ORDEN P7310 P1152 P6090 P6020 P6040 P6210 P425 P1176S1 P1176S2 P1176S3 P1176S4 P1176S5 P1176S6 P1176S7 P1176S9 P1176S10 P1176S11 P1176S12 REGION $mw $nw1 $nw2 $nw3 $ch $cu $otro $rep P1169S* // 286 variables
	gen ANNO = "2020-2021"
